...
<br/><br/>
Cada encuentro, recorrido e historia nos deja ver que siempre se ha tratado del acto de preservar. Somos lo que somos por quienes se han encargado de que la memoria no se pierda. El concepto puede sentirse lejos pero está al alcance de todos, todo el tiempo.
<br/><br/>
Queremos reconocer a quienes nunca lo han olvidado y recordárselo a quien también quiere ser parte de esto. Queremos seguir explorando todo lo que puede significar preservar y compartir el asombro de descubrirlo.
            </div>
          </div>
        </div>
      </div>
